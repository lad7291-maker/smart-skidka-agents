...
class TestHeuristicJudge(unittest.TestCase):
    ...
    def test_irrelevant_content_fails(self):
        ...
        self.assertTrue(any("скидк" in e.lower() or "промокод" in e.lower() or "цен" in e.lower()
    ...
    def test_suspicious_phrases_detected(self):
        ...
        self.assertTrue(any("галлюцинац" in e.lower() or "маркетингов" in e.lower()
                            for e in result.errors))
    ...
    def test_structure_scoring(self):
        ...
        self.assertGreater(with_headers.criteria.get("structure", 0),
    ...
    def test_criteria_present(self):
        ...
        expected_criteria = {"relevance", "readability", "structure", "usefulness", "no_hallucinations"}
